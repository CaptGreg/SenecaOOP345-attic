...
// +++++++++++++++++++++++++++++++++++++++++
// +  #include "threadsafequeue.h" START   +
// +++++++++++++++++++++++++++++++++++++++++
//#pragma once
...
int main()  // GB made this test program
{
  ...
  auto push = [&my_queue] (int arg) { 
    ...
    double d = arg + 0.1;
    my_queue.push(d);
    cout << string("thread ") + to_string(arg) + " napped " + to_string(nap) + " msec + pushed " + to_string(d) + "\n"; 
  };
  ...
  auto pop = [&my_queue] (int arg) { 
    double d; 
    my_queue.pop(d); 
    cout << string("thread ") + to_string(arg) + " popped " + to_string(d) + "\n"; 
  };
