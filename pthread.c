...
int main()
{
    ...
    args.arg1 = 5;
    args.arg2 = 7;
    args.result = args.arg1 + args.arg2;
...
// example from man pthread_create 
...
main(int argc, char *argv[])
{
   ...
   for (tnum = 0; tnum < num_threads; tnum++) {
       ...
       printf("Joined with thread %d; join returned value was %s\n",
	       tinfo[tnum].thread_num, (char *) res);
       printf("returned value in structure is  %s\n", tinfo[tnum].result);
