...
int main()
{
        ...
        cout<<"data           : "; for(auto i: v)  cout<<i<<" "; cout << endl;

        sort(v.begin(),v.end(),[](int i, int j) -> bool{ return (i < j);}); // inline ascending
        cout<<"ascending sort : "; for(auto i: v)  cout<<i<< " "; cout << endl;

        auto descending = [](int i, int j) -> bool{ return (i > j);};
        sort(v.begin(),v.end(),descending);
	cout<<"descending sort: "; for(auto i: v)  cout<<i<<" "; cout << endl;
	...
	cout << [](double m,double X,double b)-> float { return m*X + b; } (2,10,4) << endl;
	auto line = [](double m,double X,double b) -> float{ return m*X + b; };
	cout << line(2,10,4) << endl;

	cout << [](double a,double X,double b,double Y,double D) -> float { return a*X + b*Y - D; } (2,10,3,5,4) << endl;
	auto plane = [](double a,double X,double b,double Y,double D) -> float { return a*X + b*Y - D; };
	cout << plane(2,10,3,5,4) << endl;
