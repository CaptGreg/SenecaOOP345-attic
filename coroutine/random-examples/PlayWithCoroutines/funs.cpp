...
static void crit_err_hdlr1(int sig_num, siginfo_t * info, void * ucontext) // GB works
{
 void *             array[50];
 void *             caller_address;
 char **            messages;
...
#error Unsupported architecture. // TODO: Add support for other arch.
 ...
 std::cerr << "crit_err_hdlr1: signal " << sig_num << " (" << strsignal(sig_num) 
...
static void crit_err_hdlr2(int sig_num, siginfo_t * info, void * ucontext) // GB works
{
    ...
    std::cerr << "crit_err_hdlr2: signal " << sig_num 
