/*
 * MPI Mandelbrot program using static task assignment, block
 * distribution
 *
...
int master_pgm(int nworkers, int width, int height,
    ...
    int rows, rows_per_worker_quot, rows_per_worker_rem;
    ...
    /* Produce text output  */
    fprintf(stdout, "\n");
    fprintf(stdout, "MPI program with static task assignment (by blocks)\n");
